    ...
    for line in text.split("\n"):
        ...
        if cpu_match and event_match:
            ...
            if cpu_id in last_running_thread:
                ...
                thread_kernel_counts[pid][tid][
                    event_name
                ] += 1  # Update kernel call count
...
def write_to_html(extracted_data_list, output_file, file_names):
    ...
    with open(output_file, "w", encoding="utf-8") as file:
        ...
        for i, (
            ...
            file.write(
                f"<div id='allProcessesSummary{file_number}' style='display: none;'>"
            )
            ...
            cpu_headers = sorted(
                set(
                    cpu_id
                    for events in total_cpu_events_list[i].values()
                    for cpu_id in events
                )
            )
